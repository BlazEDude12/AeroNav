...
Extracted by designlang on 2026-07-07.
...
- families   NotionInter · Times New Roman · Lyon Text
- weights    400 · 500 · 700 · 600
- base size  16px

## Spacing

- scale      2px · 20px · 24px · 30px · 40px · 48px · 60px · 64px · 78px · 96px · 103px · 153px

## Radii

- scale      4px · 8px · 12px · 16px · 24px · 50px
...
- CTA verbs  download · get · request · view · english · do
